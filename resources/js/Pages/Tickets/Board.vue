...
import TimeLegend from '@/Components/Tickets/TimeLegend.vue';
...
const badgeClass = {
    ...
    asignado_ti: 'bg-blue-500',
    en_curso: 'bg-purple-500',
    levantado: 'bg-red-500',
...
<template>
    <Head title="Tablero de incidencias" />
    ...
    <AuthenticatedLayout>
        ...
        <div class="py-6 px-4 sm:px-6 lg:px-8 max-w-[1600px] mx-auto">
            <div
                class="board-scroll flex gap-4 overflow-x-auto pb-3 snap-x snap-mandatory
            ...
            >
                <BoardColumn
                    ...
                    :status="col.status"
                    :tickets="col.tickets"
                    :pill-class="pillClass[col.status]"
                    :badge-class="badgeClass[col.status]"
        ...
        <SeguimientoModal
            ...
            @updated="() => router.reload({ only: ['board'] })"
        />
